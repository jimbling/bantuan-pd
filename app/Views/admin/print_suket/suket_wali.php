...
<body>
    ...
    <div class="container-fluid">
        ...
        <p style="text-align: justify;">Bahwa anak tersebut di atas adalah benar-benar peserta didik <?php echo $data_cetak['nama_sp'] ?> Kapanewon <?php echo $data_cetak['kapanewon_sp'] ?> Kabupaten <?php echo $data_cetak['kabupaten_sp'] ?> dan masuk dalam daftar Siswa Penerima PIP Tahun <?php echo (new DateTime())->format('Y'); ?>.
        </p>
        <p style="text-align: justify;">Untuk keperluan pengambilan dana PIP, diambil oleh wali peserta didik, atas nama :
        <dl class="row">
            <dt-not-bold class="col-sm-3">Nama</dt-not-bold>
            <dd class="col-sm-9">: <?php echo $namaWali ?></dd>
            <dt-not-bold class="col-sm-3">Alamat</dt-not-bold>
            <dd class="col-sm-9">: <?php echo $alamatWali ?></dd>
            <dt-not-bold class="col-sm-3">Hubungan dengan PD</dt-not-bold>
            <dd class="col-sm-9">: <?php echo $hubunganPd ?></dd>
        </dl>
        </p>

        <p style="text-align: justify;">Demikian surat keterangan ini dibuat, agar dapat digunakan sebagaimana mestinya.
        </p>
    </div>
